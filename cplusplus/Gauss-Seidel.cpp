...
int main()
{
    ...
    cout << "5 Equations 5 Unknowns Calculator (GAUSS-SEIDEL)" << endl;
    cout << "Must not have any spaces and include the constant (1a+2b+3c+4d+5e=-6)" << endl
         << endl;
    ...
    while (true)
    {
        ...
        newB = -(-ex2r + (ex2a * newA) + (ex2c * oldC) + (ex2d * oldD) + (ex2e * oldE)) / ex2b;
        newC = -(-ex3r + (ex3a * newA) + (ex3b * newB) + (ex3d * oldD) + (ex3e * oldE)) / ex3c;
        newD = -(-ex4r + (ex4a * newA) + (ex4b * newB) + (ex4c * newC) + (ex4e * oldE)) / ex4d;
        newE = -(-ex5r + (ex5a * newA) + (ex5b * newB) + (ex5c * newC) + (ex5d * newD)) / ex5e;
    ...
    {
        cout << endl
             << "Results are reaching infinity" << endl;
